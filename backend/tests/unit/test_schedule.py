...
# Helper functions that would be implemented in schedule_service.py
...
def generate_round_robin_schedule(
    ...
    """
    # This will be implemented in backend/src/services/schedule_service.py
    raise NotImplementedError("To be implemented in T097")
